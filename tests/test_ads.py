...
def test_create_ad_without_authorization(driver, url):
    driver.get(url)
...
def test_create_ad_with_authorization(driver, url, test_user, password):
    driver.get(url)
    ...
    # TODO: ДОБАВИТЬ ПРОВЕРКУ ЧТО РАДИОБАТТОН ВЫБРАЛСЯ
